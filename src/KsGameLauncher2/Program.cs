    ...
    internal static class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            try
            {
                ...
                Language currentLanguage = new Language(cultureLanguage);

                if (!Languages.GetAvailableLanguages().Exists(delegate (Language lang) { return lang.ID == currentLanguage.ID; }))
